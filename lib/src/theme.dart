...
class PinTheme {
  ...
  factory PinTheme(
    ...
    return PinTheme.defaults(
        ...
        pinFieldColor: pinFieldColor ?? defaultValues.pinFieldColor,
        ...
        behindColor: behindColor ?? defaultValues.behindColor);
  }
}
