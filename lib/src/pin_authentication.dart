                  ...
                  if (widget.validate!) {
                    if (pin == widget.passtoValidate) {
                      ...
                      if (currentAttemp < widget.maxAttemp) {
                        ...
                        setState(() {
                          pin = "";
                          widget.action = "Intentalo nuevamente";
                        });
                      } else {
  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      child: Scaffold(
        ...
        backgroundColor: widget.pinTheme.behindColor,
        body: SafeArea(
          bottom: false,
          child: Container(
            decoration: BoxDecoration(
                color: widget.pinTheme.backgroundColor,
            ...
            child: Column(
              children: [
                ...
                Text(
                  widget.actionDescription ?? "Ingresa tu PIN para continuar",
                  style: const TextStyle(
                    // color: Colors.white,
                    fontSize: 14,
